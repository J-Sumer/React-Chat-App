    ...
    render () {
        ...
        return (
            <Segment className="message__form">
                ...
                <Input onChange={this.handleChange} onKeyDown={this.handleKeyDown} fluid name="message" style={{ marginBottom: '0.7em' }} 
                    label={<Button icon={'add'} onClick={this.handleTogglePicker} /> } labelPosition='left' placeholder='write your message'
